...
final class Version20220927114452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       $this->addSql('ALTER TABLE certificateurs ADD CONSTRAINT FK_40ACFD1D2A2AA117 FOREIGN KEY (certificateurs_id) REFERENCES certificateurs (id) ON DELETE CASCADE');
